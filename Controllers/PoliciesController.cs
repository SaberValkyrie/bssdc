...
namespace HealthInsurance.Controllers
{
    public class PoliciesController : Controller
    {
        ...
        public async Task AddPolicyRequest(PoliciesReqDetail policyRequest, string userId)
        {
            var user = await _context.UserLogins.FindAsync(userId);
            policyRequest.EmployeeId = user.IdAccount;

            _context.PoliciesReqDetails.Add(policyRequest);
            await _context.SaveChangesAsync();
        }
